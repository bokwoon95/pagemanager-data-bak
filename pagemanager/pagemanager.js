...
// createElement is a helper function wrapper around document.createElement().
...
function initImagePicker(img) {
  ...
  let sourceImage = createElement("img", {
    src: img.src,
...
function initToolbar() {
  ...
  const toolbar = createElement(
    ...
    // Save
    createElement("button", buttonAttributes({ title: "save changes to page", onclick: save }), "Save"),
  );
