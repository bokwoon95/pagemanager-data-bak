...
function setup() {
  ...
  for (const toolbarButton of toolbarButtons) {
    ...
    btn.setAttribute("title", toolbarButton.title);
    btn.innerHTML = toolbarButton.innerHTML;
    btn.addEventListener("mousedown", function (event) {
      event.preventDefault();
    });
    btn.addEventListener("click", toolbarButton.onclick);
    toolbar.append(btn);
  }
  ...
  document.querySelector("body")?.prepend(toolbarBacking);
